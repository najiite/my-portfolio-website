...
const Contact = () => {
  return (
    <>
        <div id='contact'>
            <div className='bg-gray-800/20 p-5'>
            ...
            <div className='max-w-[1240px] m-auto'>
                        ...
                        <div className='sm:grid sm:grid-cols-2'>
                            ...
                            <p className='flex items-stretch p-5'><FaEnvelope size={35}/> <a href='mailto:onajiteokeh@gmail.com' className='text-3xl mx-5 hover:main-Textcolor'>onajiteokeh@gmail.com</a></p>
